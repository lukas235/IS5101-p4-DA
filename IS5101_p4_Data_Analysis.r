...
if(!require(ggplot2)){install.packages("rcompanion")}
if(!require(stringdist)){install.packages("rcompanion")}
if(!require(stringi)){install.packages("rcompanion")}
if(!require(ggmap)){install.packages("rcompanion")}
if(!require(gridExtra)){install.packages("rcompanion")}
...
# Participants 1-10: MapA MapB
# Participants 11-20: MapB MapA
...
median(subset(data, learned==FALSE & map=="MapA")$dist)
median(subset(data, learned==TRUE & map=="MapA")$dist)
median(subset(data, learned==FALSE & map=="MapB")$dist)
median(subset(data, learned==TRUE & map=="MapB")$dist)
